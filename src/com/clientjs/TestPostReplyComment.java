...
public class TestPostReplyComment extends SeleneseTestCase
{
   ...
   public void testPostReplyComment()
      throws Exception
   {	final UUID commentId = UUID.randomUUID();
    ...
    selenium.click("//*[@class=\"gcpReplyButton\"]");	
    selenium.type("gcpCommentReplyBody", commentId+" reply");
	selenium.click("document.forms[2].elements[2]");	
	...
	verifyTrue(selenium.isTextPresent(commentId+" reply"));	
		}
}
