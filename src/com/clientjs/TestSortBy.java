...
public class TestSortBy extends SeleneseTestCase
{
   ...
   {	final UUID commentId = UUID.randomUUID();
	...
	selenium.select("gcpSortMenuTop", "Oldest first");	
	assertNotEquals(commentId+" comment",selenium.getText("//*[@class=\"gcpCommentText\"]"));
