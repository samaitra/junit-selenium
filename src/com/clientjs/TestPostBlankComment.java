...
public class TestPostBlankComment extends SeleneseTestCase
{
   ...
   public void testPostBlankComment()
      throws Exception
   {	
	...
	new Wait(){
        ...
        }.wait("Alert was not present");
	
	assertEquals("Don't you have anything to say?", selenium.getAlert());
