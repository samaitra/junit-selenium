...
public class TestCommentCountIncrement extends SeleneseTestCase
{
   ...
   {	final UUID commentId = UUID.randomUUID();
   	...
   	int commentCount = Integer.parseInt(selenium.getText("//*[@id=\"gcpCommentCount\"]"));
	...
	int expectedCount = Integer.parseInt(selenium.getText("//*[@id=\"gcpCommentCount\"]"));
	assertEquals(expectedCount, commentCount++);
	}
}
